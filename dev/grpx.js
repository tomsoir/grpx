...
(function() {
  (function(root, factory) {
    ...
    Print = (function() {
      Print.prototype.minimalOptions = ['year', 'mid', 'cmid', 'agemonths', 'grp0', 'grp1', 'grp2', 'grp3', 'grp4', 'grp5', 'grp6', 'grp7', 'mileage', 'version', 'maid'];
